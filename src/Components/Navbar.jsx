      ...
      <div className="container mx-auto">
        <nav>
          <div className="bg-[#1c1c24] w-full h-20 flex items-center justify-between ">
            <div className="logo flex items-center sm:gap-2 md:gap-6">
              <div className="flex items-center gap-1">
                <TbLocationCheck className="ml-2 sm:w-8 sm:h-10 h-8 w-6 invert" />
            ...
            <CgMenuLeftAlt className="sm:hidden invert h-8 w-16" />
          </div>
        </nav>
      </div>
    </div>
